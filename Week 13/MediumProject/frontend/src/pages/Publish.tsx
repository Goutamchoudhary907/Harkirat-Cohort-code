...
function TextEditor( {onChange} :{onChange : (e:ChangeEvent<HTMLTextAreaElement>) => void}){
   ...
   <div className="w-full mb-4 border border-gray-200 rounded-lg bg-gray-50 ">
       ...
       <div className="mt-2 bg-white rounded-b-lg focus-outline-none">
           <label htmlFor="editor" className="sr-only">Publish post</label>
           <textarea onChange={onChange}  id="editor" rows={8} className="block w-full px-0  text-sm text-gray-800 bg-white pl-2 placeholder-gray-800" placeholder="Write an article..." required ></textarea>
       </div>
       </div>
       <div>
   </div>
